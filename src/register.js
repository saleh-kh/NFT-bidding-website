            ...
            <div className="container py-12 px-6 h-full">
                <div className="flex justify-center items-center flex-wrap h-full g-6 text-white">
                    <div className="xl:w-10/12">
                        <div className="block bg-spc-c2 shadow-lg rounded-lg" id='Registersection3'>
                                        ...
                                        <form>
                                            ...
                                            <div className="flex items-center justify-between pb-6">
                                                ...
                                                <Link to='/login'>
                                                    <button
                                                        type="button"
                                                        className=" text-black hover:text-white inline-block bg-spc-g px-6 py-2 border-1 font-medium text-xs leading-tight  rounded hover:bg-spc-c hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
                                                        data-mdb-ripple="true"
                                                        data-mdb-ripple-color="light"
                                                    >
                                                        Log in
